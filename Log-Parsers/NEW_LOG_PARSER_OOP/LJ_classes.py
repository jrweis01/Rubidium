            ...
            if cmd:
                ...
                if d <= 1:
                    ...
                    for i in range(1,d+1):
                        ...
                        if self._recognize_env_and_counter(line, self._env,self.counter_num):
                            if self._get_trig_result_from_line(lines, line_num + i):
                                '''checking for double recognition printing, this
                            function will return 1 only in case of standart recognition, possible room for bugs with other results.'''
...
class TrigASRLabJackLog_LJ(TrigLabJackLog_LJ):
    ...
    def __init__(self, name):
        ...
        self._set_result_dictionaries()


    def _set_result_dictionaries(self):
